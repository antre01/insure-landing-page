...
function Footer({ handleLogoClick }) {
  return (
    <footer>
      <div className="content-wrapper">
        <div className="header">
          <img src={logo} alt="insure logo" className="logo" onClick={handleLogoClick} />
        ...
        <nav>
          <ul>
            ...
            <li className="footer-link">WHY INSURE?</li>
            <li className="footer-link">VIEW PLANS</li>
          ...
          <ul>
            <p>CONTACT</p>
            <li className="footer-link">SALES</li>
          ...
          <ul>
            ...
            <li className="footer-link">LICENSES</li>
          </ul>
        </nav>
      </div>
    </footer>
